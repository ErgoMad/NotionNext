...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '二狗也疯狂', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.0xergo.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'BTC,Bitcoin,比特币,撸毛,教程,交易', // 网站关键词 英文逗号隔开
